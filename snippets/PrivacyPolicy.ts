...
export function GeneralPrivacyPolicy(props: RenderProps, options: PrivacyPolicyOptions): string {
	...
	return /* HTML */ `
      ...
      `
		...
		<section id="data-sharing">
			...
			<p>
				${i18next.t(
					`${titleCase(iOrWe)} do not sell your personal information. ${titleCase(
						iOrWe
